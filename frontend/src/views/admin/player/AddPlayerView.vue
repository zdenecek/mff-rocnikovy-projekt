<template>
    ...
    <v-row>
       <v-col cols="12" lg="4">
         <v-form class="flex flex-col gap-05" @submit.prevent="submitForm" ref="form">
           <v-text-field label="Křestní jméno" v-model="playerData.firstName" :rules="rules.firstName" required></v-text-field>
